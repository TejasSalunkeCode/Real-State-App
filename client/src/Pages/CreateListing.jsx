...
//       const uploadTask=uploadTaskResumble(storageRef,file);
//       uploadTask.on(
//         "state_changed",
//         (error)=>{
//           reject(error);
...
//         max="10"
//         required
//         className="p-3 border-gray-300 rounded-lg border-3"
//       />
//       <p>Beds</p>
//     </div>
//     <div className="flex items-center gap-2">
...
export default function CreateListing() {
  ...
  const storeImage = async (file) => {
    return new Promise((resolve, reject) => {
      ...
      form.append("upload_preset", "react_unsigned"); // same as profile.jsx
      form.append("cloud_name", "djeknuqdt"); // same as profile.jsx

      fetch("https://api.cloudinary.com/v1_1/djeknuqdt/image/upload", {
        method: "POST",
        body: form,
      })
        .then((res) => res.json())
...
e.preventDefault();
    try {
      ...
      if (+formData.regularPrice < +formData.dicountPrice)
